...
describe('TransactionList', () => {
  ...
  describe('Computed', () => {
    ...
    test('headers()', () => {
      ...
      expect(wrapper.vm.headers).toEqual([{ 'align': 'left', 'class': 'font-weight-bold', 'sortable': false, 'text': 'Event / Venue / Location', 'value': 'event_location' }, { 'align': 'left', 'class': 'font-weight-bold', 'sortable': false, 'text': 'Creation Date', 'value': 'square_created_at' }, { 'align': 'left', 'class': 'font-weight-bold', 'sortable': false, 'text': 'Items', 'value': 'items' }, { 'align': 'left', 'class': 'font-weight-bold', 'sortable': false, 'text': 'Total', 'value': 'total_money' }, { 'align': 'left', 'class': 'font-weight-bold', 'sortable': false, 'text': 'Tax Total', 'value': 'total_tax_money' }, { 'align': 'left', 'class': 'font-weight-bold', 'sortable': false, 'text': 'Total Discount', 'value': 'total_discount_money' }, { 'sortable': false, 'value': 'action' }])
    })
