...
addParameters({
  ...
  options: {
    ...
    storySort: (a, b) => {
      if (a[1].id.indexOf(MAIN) === 0) {
        return -1
      } else if (b[1].kind.indexOf(MAIN) === 0) {
        return 1
      }
...
// const coreUiComponents = require.context('../../node_modules/@freshinup/core-ui/src/components', true, /.stories.js$/)
...
function loadStories () {
  ...
  // TODO: will activate after core ui update to 1.54.0
  // loadStoriesFrom(coreUiComponents)
