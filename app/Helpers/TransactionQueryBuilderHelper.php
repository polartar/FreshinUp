...
class TransactionQueryBuilderHelper
{
    ...
    public static function getTransactionFilters()
    {
        return [
            ...
            Filter::custom('event_tag_uuid', BelongsToWhereInUuidEquals::class, 'event.eventTags'),
            ...
            Filter::custom('item_uuid', BelongsToWhereInUuidEquals::class, 'items'),
            ...
            Filter::custom('payment_uuid', BelongsToWhereInUuidEquals::class, 'payments'),
        ];
    }
}
